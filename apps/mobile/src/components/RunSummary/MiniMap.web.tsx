...
export function MiniMap({ coordinates }: Props) {
  ...
  if (coordinates.length < 2) {
    return (
      <View
        onLayout={onLayout}
        style={{ width: '100%', height: H, borderRadius: 20, backgroundColor: '#141414', borderWidth: 1, borderColor: '#1F1F1F' }}
        ...
        return (
          <View
            ...
            style={{
              ...
              borderRadius: 2,
              boxShadow: '0 0 6px rgba(179,229,252,0.8)',
      ...
      {pts.length > 0 && (
        <>
          ...
          <View style={{
            ...
            backgroundColor: '#B3E5FC',
            boxShadow: '0 0 8px rgba(179,229,252,0.9)',
          } as any} />
        </>
      )}
    </View>
